...
export default function CheckoutFooter() {
  return (
    <div className="border-t-2 space-y-2 my-4 py-4">
      ...
      <p>
        For an item ordered from PYASTI: When you click the &apos;Place Your
        ...
        you. By placing your order, you agree to PYASTI &apos;s{" "}
      ...
      <p>
        ...
        <Link href="/page/returns-policy">See PYASTI's Returns Policy.</Link>
      </p>
    </div>
  );
}
