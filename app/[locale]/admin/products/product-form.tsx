...
const ProductForm = ({
  ...
  // Initialize specFields with existing specifications for Update mode
  const initialSpecFields =
    product && type === "Update" && product.specifications
  ...
  const [specFields, setSpecFields] =
    useState<{ key: string; value: string }[]>(initialSpecFields);

  // Ensure subCategory is set correctly for Update mode
  const initialValues =
    product && type === "Update"
      ? {
          ...product,
          subCategory:
            typeof product.subCategory === "object" && product.subCategory?._id
              ? product.subCategory._id.toString()
              : product.subCategory?.toString() || "",
          tags: product.tags || ["new"], // Ensure tags is always an array
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input
                    placeholder="Enter product name (e.g., Bosch Oil Filter)"
                    {...field}
                  />
                </FormControl>
                <FormMessage />
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input
                    placeholder="Enter part number (e.g., BOF-12345)"
                    {...field}
                  />
                </FormControl>
                <FormMessage />
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input
                    placeholder="Enter colors (e.g., Silver, Black)"
                    onChange={(e) =>
                      field.onChange(
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input
                    placeholder="Enter sizes (e.g., Standard)"
                    onChange={(e) =>
                      field.onChange(
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input
                    placeholder="Enter tags (e.g., new arrival, engine)"
                    onChange={(e) =>
                      field.onChange(
              ...
              {vehicleFields.map((field, index) => (
                ...
                >
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>Years (comma-separated)</FormLabel>
                        <FormControl>
                          <Input
