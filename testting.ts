...
//   const [isDeliveryOptionSelected, setIsDeliveryOptionSelected] =
//     useState<boolean>(false);
...
//       );
//       if (defaultIndex !== -1) {
//         handleDeliveryChange(defaultIndex);
//       }
//     }
//   }, [setting, initialize, deliveryDateIndex]);
...
//   const handleDeliveryChange = (index: number) => {
//     const delivery = availableDeliveryDates[index];
//     const effectiveShippingPrice =
//       delivery.freeShippingMinPrice > 0 &&
...
//     setShippingPrice(effectiveShippingPrice);
//   };
...
//     const effectiveTotalPrice = itemsPrice + taxPrice + shippingPrice;
...
//       setIsDeliveryOptionSelected(true);
//     } else {
//       toast({
//         description: t("Order.Please select a delivery option"),
//         variant: "destructive",
//       });
//     }
//   };
...
//       isValid: true,
//       daysToDeliver: deliveryDate.daysToDeliver,
//     };
//   };
...
//           </div>
//         )}
//         {isPaymentMethodSelected && !isDeliveryOptionSelected && (
//           <div className="mb-4">
//             <p className="text-xs text-center py-2">
...
//               <span>
//                 <ProductPrice
//                   price={itemsPrice + taxPrice + shippingPrice}
//                   plain
//                 />
//               </span>
//             </div>
...
//                       setIsDeliveryOptionSelected(false);
//                     }}
//                   >
//                     {t("All.Change")}
//                   </Button>
...
//           <div>
//             {isDeliveryOptionSelected && deliveryDateIndex !== undefined ? (
//               <div className="grid grid-cols-1 md:grid-cols-12 my-3 pb-3">
//                 <div className="flex text-lg font-bold col-span-5">
...
//                         );
//                         return (
//                           <div key={dd.name} className="flex items-center py-2">
//                             <RadioGroupItem
//                               value={dd.name}
//                               id={`delivery-${dd.name}`}
//                             />
...
//                                 {dd.name} ({dd.daysToDeliver}{" "}
//                                 {t("Order.days to deliver")}) (
//                                 {dd.shippingPrice === 0 ? (
//                                   t("Order.FREE Shipping")
//                                 ) : (
//                                   <ProductPrice
...
//                           <p className="mb-2">{t("Order.Selected Delivery")}</p>
//                           <p>{shippingMethod.name}</p>
//                           <p>{getDeliveryDateInfo(deliveryDateIndex).date}</p>
//                           <p>
//                             {shippingPrice === 0 ? (
